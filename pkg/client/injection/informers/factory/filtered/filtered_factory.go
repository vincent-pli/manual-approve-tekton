...
import (
	...
	externalversions "github.com/vincent-pli/manual-approve-tekton/pkg/client/informers/externalversions"
...
func Get(ctx context.Context, selector string) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/vincent-pli/manual-approve-tekton/pkg/client/informers/externalversions.SharedInformerFactory with selector %s from context.", selector)
	}
