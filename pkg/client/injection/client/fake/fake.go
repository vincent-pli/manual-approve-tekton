...
import (
	...
	fake "github.com/vincent-pli/manual-approve-tekton/pkg/client/clientset/versioned/fake"
...
func Get(ctx context.Context) *fake.Clientset {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/vincent-pli/manual-approve-tekton/pkg/client/clientset/versioned/fake.Clientset from context.")
	}
