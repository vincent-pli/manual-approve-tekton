...
import (
	...
	versionedscheme "github.com/vincent-pli/manual-approve-tekton/pkg/client/clientset/versioned/scheme"
	client "github.com/vincent-pli/manual-approve-tekton/pkg/client/injection/client"
	approverequest "github.com/vincent-pli/manual-approve-tekton/pkg/client/injection/informers/approverequests/v1alpha1/approverequest"
	zap "go.uber.org/zap"
...
const (
	...
	defaultFinalizerName       = "approverequests.custom.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	approverequestInformer := approverequest.Get(ctx)

	lister := approverequestInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "custom.tekton.dev.ApproveRequest"),
	)
